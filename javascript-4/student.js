...
// CODE HERE
const faveColors = ['green', 'tomato', 'magenta'];
...
const me = {
    firstName: 'Sam',
    superHeroName: 'King Average',
    homeTown: 'Mandeville',
    superPowers: ['Normal Activities', 'Sleep Boost', 'Ultimate Average'],
    superPowerXP: Math.floor(Math.random() * 10) + 1,
